...
> [!NOTE]
> This codebase was generated by the [Gemma 4 26B A4B MoE](httpshttps://ai.google.dev/gemma/docs/core/model_card_4) model using [pi](https://buildwithpi.ai/) and [opencode.ai](https://opencode.ai).
