...
> [!NOTE]
> This codebase was generated by the **Gemma 4** AI model using [pi](https://buildwithpi.ai/) and [opencode.ai](https://opencode.ai) acting together as the agent harness.
